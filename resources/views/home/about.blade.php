        ...
        <div class="mes">
            <div class="newsview">
                <div id="news_infos" class="news_infos">
                    ...
                    <img class="lazy" data-original="img/about/cb.png" style="width: 50%;float: left;margin: 20px;" class="img-fw mb-30" alt="Hi，我是陈大剩" title="Hi，我是陈大剩">
                    <p>　　大学毕业开始入坑，不知不觉已经从事PHP工作二年了。但是这对门世界上最好的语言的热爱依然不减，因为它是有趣而强大的，我还有很长的路要走！这二年已经习惯了朝7晚1的生活，也因此做了很多的项目，企业官网，商城，小程序，微信开发等等。有一些进步，但是总体提升的速度还是很缓慢，互联网的知识太多，不学习总感觉自己会退步，一定会加倍努力学习！</p>
                    <p>　　做这个博客断断续续花了一年多，从设计到前端展示再到后台都是自己亲力亲为，非常感给我博客提前意见的你们，谢谢！希望从现在开始能建立一个比较完整博客系统，并记录工作上遇到的问题和生活的点滴一起和大家分享，共同进步！</p>
                    ...
                    <p style="float:right;">2018年10月15日15:33:09<img class="lazy" data-original="img/about/mysignature.png"   style="margin-left: 30px;"  class="mt-30" alt="陈大剩签名" title="陈大剩签名"></p>
                </div>
                <div class="clear"></div>
                ...
                <div id="tvme" class="weixin tvme">
                    ...
                    <div class="travel">
                        ...
                        <p>　　“骑行西藏”一直是我的梦想，阅读也是我爱好，从大学开始，我每周看一本书，日兼两份职。大二便自己独立经济，兼职户外俱乐部，也随着户外俱乐部在全国游山涉水，15年终于圆了自己的骑行梦，经三十天风雪顺利到达拉萨。</p>
                        <p>　　以下是我去过的一些地方剪辑，希望大家喜欢   ↓</p>
                        <div class="tv"><iframe  id="movie" height="100%" allowfullscreen="true"  width="100%" src='http://player.youku.com/embed/XMjcyNzQ5NTM1Mg==' frameborder=0 'allowfullscreen'></iframe></div>
                    </div>
                </div>
                    ...
                    <div class="learn">
                        <ul>
                            <li>
                                ...
                                <div class="intro"><p> 作为一个IT码农一天不学习你会不会觉得心里不安？作为一名PHP工程师，我无时无刻在提醒自己要不断学习充实自己，一天不学习我就害怕被这个互联网抛弃了 。读书这么多年，我从来没有像这样努力过。已经很久没玩游戏了，看书和视频都是技术相关的，很久没有看过电视剧了。</p></div>
                                <div class="img"><img class="lazy" data-original="img/about/bc.jpg"   alt="编程学习" title="编程学习"></div>
                            </li>
                            <li>
                                <div class="title">
                                    <div class="index">
                                ...
                                <div class="intro"><p>生活也是一个不断学习的过程，谁也不可能一出生就什么都会，只有不断的提升自己，增加自己的知识储备，才有更好的发展前景。我有很多爱好，比如游泳、弹琴、溜冰、羽毛球等等，正是因为我这些爱好迫使着我不断学习，从15年开始，我陆续考得了《5级救生员》、《5级游泳教练员》等等。</p></div>
                                <div class="img"><img class="lazy" data-original="img/about/yd.jpg"  alt="生活学习" title="生活学习"></div>
                            </li>
                            <li>
                                <div class="title">
                                    <div class="index">
                                ...
                                <div class="intro"><p>IT 行业是一个变化非常快的行业，它需要我们持续去学习新的知识和技能。 但是，工作以后，我们经常会发现自己学习的东西很少了，倒不是没有时间去学习， 而是学习的效率太低了。久而久之，就演变成『一年的工作经验，重复用十年』。所以我只能不断努力！加油！</p></div>
                                <div class="img"><img class="lazy" data-original="img/about/work.jpg"   alt="工作学习" title="工作学习"></div>
                            </li>
                        </ul>
                    </div>
                </div>
