...
<head>
    ...
    <link rel="stylesheet" href="{{cdn_asset('lib/layui/css/font.css')}}">
    <link rel="stylesheet" href="{{cdn_asset('lib/layui/css/layui.css')}}">
...
@yield('body')
<script src="{{cdn_asset('lib/layui/layui.js')}}"></script>
